        ...
        topLocations: [
            {
                ...
                img: '/assets/images/destinations/sensoji.jpg',
            ...
            },
            {
                id: 2,
                name: 'Tokyo Tower',
                img: '/assets/images/destinations/tokyo_tower.jpg',
                location: '4 Chome-2-8 Shibakoen, Minato City, Tokyo 105-0011, Japan',
                info: 'The Tokyo Tower is an iconic landmark offering panoramic views of the city. It´s a symbol of Japan´s post-war rebirth and modernization.'
            },
            {
                id: 4,
                name: 'Meiji Shrine',
                img: '/assets/images/destinations/meiji.jpg',
                location: '1-1 Yoyogikamizonocho, Shibuya City, Tokyo 151-8557, Japan',
                info: 'Meiji Shrine is a serene Shinto shrine set in a forested area. It´s dedicated to Emperor Meiji and Empress Shoken, surrounded by tranquil gardens.'
            },
        ...
        topLocations: [
            {
                id: 1,
                name: 'Colosseum',
                img: '/assets/images/destinations/colosseum.jpg',
            ...
            },
            {
                id: 2,
                name: 'Roman Forum',
                img: '/assets/images/destinations/roman_forum.jpg',
            ...
            },
            {
                id: 3,
                name: 'Trevi Fountain',
                img: '/assets/images/destinations/trevi_fountain.jpg',
                location: 'Piazza di Trevi, 00187 Roma RM, Italy',
                info: 'The Trevi Fountain is a stunning Baroque masterpiece and the largest fountain in Rome. Legend says tossing a coin ensures a return to Rome.'
            },
            {
                id: 4,
                name: 'Pantheon',
                img: '/assets/images/destinations/pantheon.jpg',
                location: 'Piazza della Rotonda, 00186 Roma RM, Italy',
                info: 'The Pantheon is an ancient Roman temple known for its iconic dome and architectural grandeur. It´s a marvel of ancient engineering.'
            },
        ]
    },
    {
        ...
        topLocations: [
            {
                id: 1,
                name: 'Times Square',
                img: '/assets/images/destinations/times_square.jpg',
            ...
            },
            {
                id: 2,
                name: 'Central Park',
                img: '/assets/images/destinations/central_park.jpg',
            ...
            },
            {
                ...
                img: '/assets/images/destinations/statue.jpg',
                location: 'New York, NY 10004, United States',
                info: 'The Statue of Liberty is a symbol of freedom and democracy, offering panoramic views of the city and an insight into American history.'
            },
            {
                id: 4,
                name: 'Empire State Building',
                img: '/assets/images/destinations/empire.jpg',
                location: '20 W 34th St, New York, NY 10118, United States',
                info: 'The Empire State Building is an iconic skyscraper, offering breathtaking views from its observation deck and a glimpse into NYC’s skyline.'
            },]
    },
];
