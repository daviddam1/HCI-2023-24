    ...
    <section className='bg-[#2A3C4B] pt-1'>
      ...
      <div className='flex flex-col md:flex-row p-4 md:p-20 text-white'>
          ...
          <div className='flex justify-around'>
              <div className='w-full flex flex-col items-start text-[14px] px-12 ml-8 md:ml-64'>
                <h2 className='pt-8 pb-5 text-[#F2E863] font-semibold text-[16px] md:text-[18px]'>Spaces</h2>
                {sitemap.map((item) => (
              ...
              <div className='w-full flex flex-col items-start text-[14px] px-12'>
                <h2 className='pt-8 pb-5 text-[#F2E863] font-semibold text-[16px] md:text-[18px]'>My Account</h2>
      ...
      <div className='flex justify-center pb-4 md:pb-6 mt-4 md:pt-2'>
        <FontAwesomeIcon className='px-6 md:px-10 hover:scale-110' icon={faFacebookSquare} size='2x' color='#F2E863' />
        <FontAwesomeIcon className='px-6 md:px-10 hover:scale-110' icon={faInstagramSquare} size='2x' color='#F2E863' />
        <FontAwesomeIcon className='px-6 md:px-10 hover:scale-110' icon={faTwitterSquare} size='2x' color='#F2E863' />
        <FontAwesomeIcon className='px-6 md:px-10 hover:scale-110' icon={faDiscord} size='2x' color='#F2E863' />
      </div>
