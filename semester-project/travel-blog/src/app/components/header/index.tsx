        ...
        <div className='w-full flex flex-row justify-between pt-7 px-4 md:px-20'>
                <Link href={"/"}>
                    <div className='flex items-center mt-3'>
                        <Image className='scale-75 md:scale-100' src="/assets/icons/traveler.png" width={78} height={68} alt="logo" />
                        <span className='font-bold text-[18px] md:text-[22px] text-[#F2E863] pt-3'>Traveler</span>
                    </div>
                </Link>
                ...
                <div className='items-center justify-end pt-9 px-4 hidden max-lg:block'>
